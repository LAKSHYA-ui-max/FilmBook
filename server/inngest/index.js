...
const syncUserUpdation = inngest.createFunction(
    ...
    async ({ event }) =>{
        ...
        await User.findByIdAndUpadted(id, userData)
    }
)

// Ingest function to cancel booking and release seats of show after 10 minutes of booking created if the payment is not made
        ...
        await sendEmail({
            ...
            body : `<div style="font-family: Arial, sans-serif; line-height: 1.5;">
                        ...
                        <p>
                            ...
                            showDateTime).toLocaleTimeString('en-US', { timeZone: 'Asia/Kolkata' })}
                        </p>
                        <p>Enjoy the show!</p>
...
//Inngetst function to send reminders
...
export const functions = [
    ...
    sendShowReminders,sendNewShowNotification
];